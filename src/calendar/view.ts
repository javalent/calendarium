...
export const VIEW_TYPE = "CALENDARIUM";
...
interface CalendariumViewState {
    ephemeral: EphemeralState;
    calendar: string;
}

export default class CalendariumView extends ItemView {
    ui: CalendarUI;
    ...
    getState(): CalendariumViewState {
        const state = {
            calendar: this.calendar,
            ephemeral: this.store?.ephemeralStore?.getEphemeralState(),
        };
        return state;
    }
